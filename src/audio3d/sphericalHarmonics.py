...
maxn[shi(5,+2)] = math.sqrt( 5*3./7)*math.sqrt(11*math.sqrt(21) +54)/(+math.sqrt(21) + 6 ) # 0.70750122131450299
maxn[shi(5,+1)] = 1./( 4*math.sqrt(21)*math.sqrt( 399 +11*math.sqrt(21*11) ) /525 )
maxn[shi(5, 0)] = 1.
maxn[shi(5,-1)] = 1.
maxn[shi(5,-2)] = 1.
maxn[shi(5,-3)] = 1.
